(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".content-testimonials__slider")) new core(".content-testimonials__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".content-testimonials__prev",
                    nextEl: ".content-testimonials__next"
                },
                on: {}
            });
        }
        ...
        const textBox = document.querySelectorAll(".card-stories__text");
        textBox.forEach((element => {
            let sliced = element.textContent.slice(0, 87);
            if (sliced.length < element.textContent.length) sliced += "...";
